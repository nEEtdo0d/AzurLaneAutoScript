...
def main(ini_name=''):
    ...
    # distress
    distress = daily_parser.add_argument_group('Distress settings', 'Must enable fleet control for proper fleet preparation. Settings formation, mode, and step are used as-is.', gooey_options={'label_color': '#931D03'})
