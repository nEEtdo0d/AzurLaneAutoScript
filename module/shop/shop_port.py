...
from module.shop.clerk import ShopClerk, OCR_SHOP_AMOUNT
...
class PortShop(ShopClerk, ShopStatus):
    ...
    def shop_filter(self):
        ...
        Returns:
            str:
        """
        if self.config.OpsiShopBeta_PresetFilter != 'custom':
            return PORT_SHOP_PRESET[self.config.OpsiShopBeta_PresetFilter]
        return self.config.OpsiShopBeta_CustomFilter.strip()
    ...
    shop_template_folder = './assets/shop/os_beta'
