...
if server.server != 'tw':
    OCR_SHOP_GOLD_COINS = Digit(SHOP_GOLD_COINS, letter=(100, 100, 100), name='OCR_SHOP_GOLD_COINS')
    OCR_SHOP_MEDAL = Digit(SHOP_MEDAL, letter=(100, 100, 100), name='OCR_SHOP_MEDAL')
    OCR_SHOP_MERIT = Digit(SHOP_MERIT, letter=(100, 100, 100), name='OCR_SHOP_MERIT')
    OCR_SHOP_GUILD_COINS = Digit(SHOP_GUILD_COINS, letter=(100, 100, 100), name='OCR_SHOP_GUILD_COINS')
    OCR_SHOP_CORE = Digit(SHOP_CORE, letter=(100, 100, 100), name='OCR_SHOP_CORE')
else:
