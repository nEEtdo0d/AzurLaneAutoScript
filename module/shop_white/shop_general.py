...
from module.shop.shop_general import GeneralShop as GeneralShopBase
from module.shop_white.ui import ShopUI


class GeneralShop(GeneralShopBase, ShopUI):
    @cached_property
    def shop_general_items(self):
        ...
        shop_general_items = ShopItemGrid(shop_grid, templates={},
